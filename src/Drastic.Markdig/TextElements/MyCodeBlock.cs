...
internal class MyCodeBlock : IAddChild
{
    ...
    public MyCodeBlock(CodeBlock codeBlock)
    {
        ...
        border.Padding = new Microsoft.UI.Xaml.Thickness(8);
        border.Margin = new Microsoft.UI.Xaml.Thickness(4);
        border.CornerRadius = new Microsoft.UI.Xaml.CornerRadius(4);
