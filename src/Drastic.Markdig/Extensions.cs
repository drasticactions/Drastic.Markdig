...
public static class Extensions
{
    ...
    {
        Microsoft.UI.Xaml.Application.Current.Resources.TryGetValue("SystemAccentColor", out var accentColor);
        // Create a SolidColorBrush from the accent color
        var accentBrush = new SolidColorBrush((Windows.UI.Color)accentColor);
